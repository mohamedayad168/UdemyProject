...
namespace Udemy.Service.IService
{
    public interface ICoursesService
    {
        ...
        public Task<PaginatedRes<CourseRDTO>> GetPageAsync(PaginatedSearchReq searchReq, DeletionType deletionType, bool trackChanges);
        ...
        Task<PaginatedRes<CourseSearchDto>> GetAllWithSearchAsync(CourseRequestParameter requestParamter);
    }
