        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestSeller = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartCourse", x => new { x.CartId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_CartCourse_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartCourse_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseOrder", x => new { x.OrderId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 11111, 0, 30, "New York", "a6f7f5da-46c8-4c42-bdd8-da862592c356", "United States", new DateTime(2025, 3, 11, 19, 45, 14, 556, DateTimeKind.Local).AddTicks(3132), "admin@gmail.com", true, "Admin", "M", false, "Admin", false, null, null, "ADMIN@gmail.com", "ADMIN", "AQAAAAIAAYagAAAAENmGrXNVBceH/y28jKHacqQ7j/r7neOJEAf+n+WcK/RYoTJJmXtkMtj+MG6i0JOo1A==", null, false, "e7de5b77-a395-4ba2-8c9f-7208651753f6", "New York", false, "admin" },
                    { 22222, 0, 30, "New York", "bf29ce92-f802-40a0-bb76-1b0cc68fa309", "United States", new DateTime(2025, 3, 11, 19, 45, 14, 644, DateTimeKind.Local).AddTicks(7969), "instructor@gmail.com", true, "Instructor", "M", false, "Instructor", false, null, null, "INSTRUCTOR@gmail.com", "INSTRUCTOR", "AQAAAAIAAYagAAAAEOnxp9Esp9h5UL5bMdq8ObqC6yNr4M3JFmvyQoI6pC5trTDWODayZG65YqqIwLwS5g==", null, false, "a9c638cd-650b-4cb2-afbe-bc4606ca1139", "New York", false, "instructor" },
                    { 33333, 0, 30, "New York", "e0278ef2-7590-4ffc-ae6b-ee95a4c7d214", "United States", new DateTime(2025, 3, 11, 19, 45, 14, 735, DateTimeKind.Local).AddTicks(7269), "student@gmail.com", true, "Student", "M", false, "Student", false, null, null, "STUDENT@gmail.com", "STUDENT", "AQAAAAIAAYagAAAAEB/kMbsj1N84NM/mgtLFd6UcOv9NwoOWmjpevydz+xdsBpKlW0DK/RKWQuorL7p8mw==", null, false, "82affb32-e25c-4df5-bbbd-482ff959eda1", "New York", false, "student" }
                });
