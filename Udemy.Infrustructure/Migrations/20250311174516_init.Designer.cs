            ...
            modelBuilder.Entity("Udemy.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "a6f7f5da-46c8-4c42-bdd8-da862592c356",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 11, 19, 45, 14, 556, DateTimeKind.Local).AddTicks(3132),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENmGrXNVBceH/y28jKHacqQ7j/r7neOJEAf+n+WcK/RYoTJJmXtkMtj+MG6i0JOo1A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e7de5b77-a395-4ba2-8c9f-7208651753f6",
                            State = "New York",
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Instructor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "bf29ce92-f802-40a0-bb76-1b0cc68fa309",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 11, 19, 45, 14, 644, DateTimeKind.Local).AddTicks(7969),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOnxp9Esp9h5UL5bMdq8ObqC6yNr4M3JFmvyQoI6pC5trTDWODayZG65YqqIwLwS5g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a9c638cd-650b-4cb2-afbe-bc4606ca1139",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "instructor",
                            Wallet = 0m
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "e0278ef2-7590-4ffc-ae6b-ee95a4c7d214",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 11, 19, 45, 14, 735, DateTimeKind.Local).AddTicks(7269),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEB/kMbsj1N84NM/mgtLFd6UcOv9NwoOWmjpevydz+xdsBpKlW0DK/RKWQuorL7p8mw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "82affb32-e25c-4df5-bbbd-482ff959eda1",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "student",
                            Title = "Student",
