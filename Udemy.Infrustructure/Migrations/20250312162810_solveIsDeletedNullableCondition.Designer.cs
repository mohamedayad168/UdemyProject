...
namespace Udemy.Infrastructure.Migrations
{
    ...
    [Migration("20250312162810_solveIsDeletedNullableCondition")]
    partial class solveIsDeletedNullableCondition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Udemy.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "6c3df827-a0b9-40d7-9bea-1c3ed6f51528",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 12, 18, 28, 9, 395, DateTimeKind.Local).AddTicks(3980),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBWpB1Tvz7ph8kuyWb4brzUQZLcrEiXlYJtfMHUv5JBQGmSknyV1B7fPQUo1k3S1Ww==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "76dc839c-0095-458d-a5dc-9fde92cb8a0e",
                            State = "New York",
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Instructor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "a51fbaef-e7b8-48b1-a14f-1bed4995c88a",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 12, 18, 28, 9, 489, DateTimeKind.Local).AddTicks(5210),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBXh1YcWd/2vw2ME+1ZBzUI7gtqZAyIbk2Fp/BUVGD7euOKSH6EQdMB/tJ0yEP3vwA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "63b84041-6779-400f-90ec-84665177453d",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "instructor",
                            Wallet = 0m
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "0c2ec0a5-07cc-4b8c-8018-5a6c8e5a62a5",
                            CountryName = "United States",
                            CreatedDate = new DateTime(2025, 3, 12, 18, 28, 9, 583, DateTimeKind.Local).AddTicks(6063),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGICxeleKBzqukH7bgYFAOCCrNbTd2vk2BkhX4KulFNWfY3eBGCJaapWotlt+dQL1g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0cc49928-910e-4b3b-a922-05c00534b98e",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "student",
                            Title = "Student",
