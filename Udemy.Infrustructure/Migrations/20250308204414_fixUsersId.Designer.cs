...
namespace Udemy.Infrastructure.Migrations
{
    ...
    [Migration("20250308204414_fixUsersId")]
    partial class fixUsersId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Udemy.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "395e0c92-4ce7-441f-9d64-748579039dba",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBWFh5ipNfFBEVAw4gzA7K1+zj/ZoyU+u2s/i2Ldqb8p1qT1toNcYmohIv2JHDmKcg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6f583d56-d71a-49aa-825b-bf536b484292",
                            State = "New York",
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Instructor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "535cd4b1-d645-4f98-9349-c7762a481d24",
                            CountryName = "United States",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKCMKtnpMwVsM7rk/C3heGWBdY+s044xVcrwvQR++pBVkWrAEk/yMUoaKSx8MVZfMw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "76663652-7baf-4c90-a31d-b148ce486995",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "instructor",
                            Wallet = 0m
            ...
            modelBuilder.Entity("Udemy.Core.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 30,
                            City = "New York",
                            ConcurrencyStamp = "6825703b-3fca-492b-905c-8edbd68f3061",
                            CountryName = "United States",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHxoSpt0UH8yLau7+rtXRckgn/vkiKFKR8x6ChBXjOVBGjnW5aQvn5YP4UkXVyB1Fg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f46a7c70-f5c8-4f0a-b252-c39fee1aca99",
                            State = "New York",
                            TwoFactorEnabled = false,
                            UserName = "student",
                            Title = "Student",
