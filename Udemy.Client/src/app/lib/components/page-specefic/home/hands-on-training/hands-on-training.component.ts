...
export class HandsOnTrainingComponent {
  ...
  features: Feature[] = [
    ...
    },
    {
      ...
      description:
        'Enterprise Plan - Fast-track goals with advanced insights plus a dedicated customer success team to help drive effective learning.',
      details:
    ...
    },
    {
      ...
      description:
        'Enterprise Plan - Create tailored learning paths for team and organization goals and even host your own content and resources.',
      details:
